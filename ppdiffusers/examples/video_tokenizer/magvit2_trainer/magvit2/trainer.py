    ...
    def on_log(self, args, state, control, logs=None, **kwargs):
        ...
        if (
            ...
            with self.autocast_smart_context_manager(args):
                image_logs["reconstruction"] = model.log_reconstruct_frames(inputs)
                image_logs["original"] = model.log_original_frames(inputs)
...
class AdvancedVideoTokenizerTrainer(Trainer):
