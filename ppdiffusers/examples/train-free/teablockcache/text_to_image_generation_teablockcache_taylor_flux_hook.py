...
# Optional: Clean up - disable the cache optimization
# Note: This is automatically handled when the pipeline is deleted,
# but you can manually disable it if needed
# from ppdiffusers.hooks import remove_teablockcache_taylor
# remove_teablockcache_taylor(pipeline.transformer) 